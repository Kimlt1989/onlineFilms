<%-- 
    Document   : index
    Created on : Feb 19, 2020, 1:25:24 PM
    Author     : Kim Ly
--%>
        ...
        <div class="owl-carousel owl-theme js" id="slider1">
            ...
            <div class="item px-2">
                <div class="fh5co_latest_trading_img_position_relative">
                    <div class="fh5co_latest_trading_img"><img src="images/GameImages/<%=each.getImage()%>" alt=""
                                                           class="fh5co_img_special_relative"/></div>
                    <div class="fh5co_latest_trading_img_position_absolute"></div>
                    <div class="fh5co_latest_trading_img_position_absolute_1">
                        <a href="single.html" class="text-white"> <%=each.getName()%> </a>
                        <div class="fh5co_latest_trading_date_and_name_color"> <%=each.getIssuedate()%> </div>
                    </div>
                </div>
            </div>
                    <%
...
<div class="container-fluid pb-4 pt-5">
    <div class="container animate-box">
        <div>
            <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">Trailers</div>
        </div>
       <div>
    ...
    <div class="container paddding">
        <div class="row mx-0">
            <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                <div>
                    <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">Top description</div>
                </div>
                <div class="row pb-4">
                    <div class="col-md-5">
                        <div class="fh5co_hover_news_img">
